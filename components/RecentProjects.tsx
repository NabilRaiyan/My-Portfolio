  ...
  return (
    <div className='py-20' id='projects'>
      ...
      <div className='flex flex-wrap items-center justify-center gap-x-24 gap-y-8 mt-[12rem]'>
            {
                projects.map((item)=>(
                    <div key={item.id} className='sm:h-[41rem] lg:min-h-[32.5rem] h-[45rem] items-center justify-center
                                sm:w-96 w-[80vw]'>
                        <PinContainer title={item.link} href={item.link}>
                            <div className='relative flex items-center justify-center 
                                ...
                                <Image fill src={item.img} alt={item.title} className='z-10 absolute bottom-0' />
                            </div>
                            <h1 className='mt-3 font-bold text-base line-clamp-1 lg:text-2xl md:text-xl'>{item.title}</h1>
